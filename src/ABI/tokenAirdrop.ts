export const TOKEN_AIRDROP_ABI= [
  ...
  "function getDropInfo(address user) view returns (string _name, address creatorAddress, uint256 totalClaimed, uint256 totalClaimable, uint256 totalClaimedtoken, uint256 totalClaimabletoken, uint256 _creationTime, uint256 _endtime, bool _hasOwnerWithdrawn, bool _hasUserClaimedAirdrop, address _nftAddress, address _tokenAddress)",

  // Write/public functions
  "function claimAirdrop(uint256 _amount, bytes32[] calldata _merkleProof) external",
  "function claimAirdrop(uint256 _amount, bytes32[] calldata _merkleProof, uint256 _tokenId) external",
